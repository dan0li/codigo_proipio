...
def cargar_datos():
    property_df = pd.read_csv('Torrevieja/Spain-torrevieja_Property_Extended_Match_2023-11-23/Spain-torrevieja_Property_Extended_Match_2023-11-23.csv')
    daily_df = pd.read_csv('Torrevieja/Spain-torrevieja_Daily_Match_2023-11-23/Spain-torrevieja_Daily_Match_2023-11-23.csv')
    monthly_df = pd.read_csv('Torrevieja/Spain-torrevieja_Monthly_Match_2023-11-23/Spain-torrevieja_Monthly_Match_2023-11-23.csv')
    return property_df, daily_df, monthly_df

torrevieja_property, torrevieja_daily, torrevieja_monthly = cargar_datos()
...
# Mostrar mapa
m = generar_mapa(df_filtrado)
map_data = st_folium(m, width=1000, height=600)

# Extraer clic del usuario
...
if clicked:
    ...
    st.sidebar.plotly_chart(fig_adr, use_container_width=True)
